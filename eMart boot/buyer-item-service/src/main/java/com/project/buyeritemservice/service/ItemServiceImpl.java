...
public class ItemServiceImpl implements ItemService {
	...
	public ItemPojo addItem(ItemPojo itemPojo) {
		...
		subCategoryEntity.setSubCategoryId(subCategoryPojo.getSubCategoryId());
		SellerSignupEntity sellerSignupEntity = new SellerSignupEntity();
		sellerSignupEntity.setSellerId(sellerSignupPojo.getSellerId());
		ItemEntity itemEntity = new ItemEntity(itemPojo.getItemId(), itemPojo.getItemName(), itemPojo.getItemImage(),
				itemPojo.getItemPrice(), itemPojo.getItemStock(), itemPojo.getItemDescription(), subCategoryEntity,
				itemPojo.getItemRemarks(), sellerSignupEntity);
